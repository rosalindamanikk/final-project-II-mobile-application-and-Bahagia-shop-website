...
abstract class $OrderModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String code, double total, String paymentMethod,String description});
}
...
class _$_OrderModel implements _OrderModel {
  ...
  @override
  String toString() {
    return 'OrderModel(id: $id, code: $code, total: $total, paymentMethod: $paymentMethod, description:$description)';
  }
...
abstract class _OrderModel implements OrderModel {
  factory _OrderModel(
      ...
      required final String description}) = _$_OrderModel;
