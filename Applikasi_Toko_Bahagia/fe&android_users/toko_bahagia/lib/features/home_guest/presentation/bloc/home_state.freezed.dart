...
abstract class $HomeStateCopyWith<$Res> {
  factory $HomeStateCopyWith(HomeGuestState value, $Res Function(HomeGuestState) then) =
      _$HomeStateCopyWithImpl<$Res, HomeGuestState>;
}

/// @nodoc
class _$HomeStateCopyWithImpl<$Res, $Val extends HomeGuestState>
...
class _$HomeLoadedState implements HomeLoadedState {
  ...
  @override
  String toString() {
    return 'HomeState.loadedState(productList: $productList)';
  }
...
abstract class HomeLoadedState implements HomeGuestState {
  const factory HomeLoadedState(
      {required final List<Product> productList }) = _$HomeLoadedState;
